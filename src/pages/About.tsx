          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
              ...
              <motion.div
                ...
                transition={{ duration: 0.6 }}
                className="relative aspect-square sm:aspect-video lg:aspect-square rounded-2xl sm:rounded-3xl overflow-hidden"
              >
                <img 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
              {processSteps.map((step, index) => (
                <motion.div
                  ...
                  className="p-6 sm:p-8 glass rounded-2xl relative"
                >
                  <span className="text-4xl sm:text-6xl font-serif font-bold text-primary/10 absolute top-4 right-4">
                    0{index + 1}
                  </span>
                  <h3 className="text-lg sm:text-xl font-serif font-bold mb-3 sm:mb-4 relative z-10">{step.title}</h3>
                  <p className="text-sm sm:text-base text-foreground/60 relative z-10">{step.desc}</p>
                </motion.div>
              ))}
            </div>
          </div>
